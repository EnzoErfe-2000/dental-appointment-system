  ...
  <?php require_once("header.php");?>
    <div class="content-section" style="width:75%">
        ...
        if(mysqli_num_rows($res) > 0)
        {
            ...
            {
                $id = $row['clinic_id'];
                $link = "schedules.php?location=".$id."";
                $cl ="spllink";
                echo "<tr><td>".$id."</td><td>".$row['clinic_location']."</td><td>".$row['clinic_open_hr']."</td><td>".$row['clinic_close_hr']."</td><td><a class='nav__links' href='".$link."' class='".$cl."'>Check Dentists</a></td></tr>";
            }
        }
        else
