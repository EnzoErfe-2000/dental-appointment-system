<?php  
      ...
      if(isset($_POST['reg_user']))
      {
        ...
        $code = mysqli_real_escape_string($db, $_POST['re_code']);
        //regex validation 
        ...
        else
        {
          ...
          if($user)
          {
            ...
            $code_check_query= "SELECT * FROM registration_code WHERE regCode_number='$code' AND regCode_validity ='1' LIMIT  1 ";
            // echo $code_check_query;
            $res= mysqli_query($db, $code_check_query);
            $validCode = mysqli_fetch_assoc($res);
            if ($validCode) {
              // echo "success";
              
              // TODO Update validity of registration code
              $update_code_query= "UPDATE registration_code SET regCode_validity = '0' WHERE regCode_number='$code'";
              if (mysqli_query($db, $update_code_query)) {
                // Create a new User
                ...
                array_push($errors, "Error updating registration code validity: " . mysqli_error($db));
              }
              

            }
            else {
              array_push($errors, "Invalid Code. Refer to your administrator to get a valid code");
            }
          }
        }
      }
            ...
            <div class="container" style='width:950px'>
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Dentist/Admin<br>Sign up</h2>
                        <?php
                        if(sizeof($errors)>0)
                        {
                        ...
                        <form method="POST" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                            <label for="re-code"><i class="zmdi zmdi-lock-outline"></i></label>
                                <input type="password" name="re_code" id="re_code" placeholder="Registration Code" required />
                          </div>
                           <div class="form-group">
                    ...
                    <div class="signup-image">
                        ...
                        <a href="login1.php" class="signup-image-link">Already a member? Log in</a>
                    </div>
                </div>
            </div>
        </section>
