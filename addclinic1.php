<?php
    ...
    if(isset($_POST['add_clinic']))
    {
        ...
        if($t2 > $t1)
        {
            ...
            $query = "INSERT INTO clinic(clinic_location, clinic_open_hr, clinic_close_hr) VALUES ('$locn', '$open_hr', '$close_hr')"; 
            //echo $query;
...
<body>
  ...
  <div class="content-section" style="width:70%">
    ...
    <table>
        ...
        <tr><th>Opening Hour</th><td><input list='times' name='open_hr' required><datalist id='times'><option value='09:00'><option value='10:00'><option value='11:00'>
