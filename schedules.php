...
<body>
  ...
  <?php require_once("header.php");?>
    <div class="content-section" style="width:75%">
        <?php 
        $query2 = "SELECT clinic_location FROM clinic WHERE clinic_id = '$locn' LIMIT 1";
        ...
        else 
        {
            ...
            $query = "SELECT * FROM dentist WHERE clinic_location = '$loc'";
            //echo $query;
            ...
            else
            {
                ...
                {
                    $link = "makeappointment1.php?dentist=".$row['dentist_name']."";
                    // echo "<tr><td>Dr. ".$row['name']."</td><td>".$row['d_type']."</td><td><a href='$link'>Make Appointment</a></td></tr>";
                    echo "<tr><td>Dr. ".$row['dentist_name']."</td><td>".$row['dentist_specialization']."</td><td><a href='$link'>Make Appointment</a></td></tr>";
                }
            }
        }
        ?>
